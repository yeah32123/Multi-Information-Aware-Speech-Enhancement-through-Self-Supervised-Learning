...
class DCUnet10(nn.Module):
    ...
    Deep Complex U-Net.
    """
    def __init__(self, n_fft, hop_length, device):
        super().__init__()
    ...
    # downsampling/encoding 
    def forward(self, x, n_fft, hop_length, device,is_istft=True):
...
class DCUnet10_cTSTM(nn.Module):
    ...
    def __init__(self, n_fft, hop_length, device):
        ...
        # upsampling/decoding
        self.upsample0 = Decoder(filter_size=(3,3), stride_size=(2,1), in_channels=64, out_channels=64)
        self.upsample1 = Decoder(filter_size=(3,3), stride_size=(2,2), in_channels=128, output_padding=(0,1), out_channels=64)
        self.upsample2 = Decoder(filter_size=(3,3), stride_size=(2,2), in_channels=128, out_channels=64)
        self.upsample3 = Decoder(filter_size=(3,3), stride_size=(2,2), in_channels=128, output_padding=(1,0), out_channels=32)
        self.upsample4 = Decoder(filter_size=(3,3), stride_size=(2,2), in_channels=64,
                                 out_channels=1, last_layer=True)
