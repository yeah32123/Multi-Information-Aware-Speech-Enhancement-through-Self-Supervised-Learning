...
class DCUnet20(nn.Module):
    ...
    def __init__(self, n_fft=64, hop_length=16):
        ...
        # TSTM
        self.dual_transformer_real = Dual_Transformer(128, 128, nhead=4, num_layers=6)   # [b, 64, nframes, 8]
        self.dual_transformer_imag = Dual_Transformer(128, 128, nhead=4, num_layers=6)   # [b, 64, nframes, 8]
    ...
    def forward(self, x, is_istft=True):
        ...
        p_real = self.dual_transformer_real(x_real)-self.dual_transformer_imag(x_imag)
        p_imag = self.dual_transformer_real(x_real)+self.dual_transformer_imag(x_imag)    
