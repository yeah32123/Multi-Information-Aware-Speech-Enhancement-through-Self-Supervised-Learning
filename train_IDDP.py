...
if noise_class == "white":
    TRAIN_INPUT_DIR = Path('/home/maoyj/projects/Noise2Noise-audio_denoising_without_clean_training_data/Datasets/WhiteNoise_Train_Input')
    TRAIN_TARGET_DIR = Path('/home/zhangyh/project/SE/Noise2Noise-audio_denoising_without_clean_training_data/Datasets/WhiteNoise_Train_Output')

    TEST_NOISY_DIR = Path('/home/maoyj/projects/Noise2Noise-audio_denoising_without_clean_training_data/Datasets/WhiteNoise_Test_Input')
